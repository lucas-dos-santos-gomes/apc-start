...
function MaterialInfo(){
    return(
        ...
        <div class="livro-encostado">
            <img src="/src/assets/img/material/livros-encostados.png" alt=""/>
        </div>

        <div class="Mate-texto">
        ...
        <div class="livro-aberto">
            <img src="/src/assets/img/material/livro-aberto.png" alt=""/>
        </div>
    </section>

...
function MaterialExplica(){
    return(
        ...
        <section id="Materiais-explicacao">
            ...
            <div class="Mate-explicacao">
                <div class="livro-imagem">
                    <img src="/src/assets/img/material/livro-amarelo.png" alt=""/>
                </div>

                <div class="livro-texto">
                    <h2><span class="mat-yellow">Alfabetizando com Jogos e Atividades Divertidas</span></h2>
            ...
            <div class="Mate-explicacao">
                <div class="livro-imagem">
                    <img src="/src/assets/img/material/livro-azul.png" alt=""/>
                </div>

                <div class="livro-texto">
                    <h2><span class="mat-blue">Alfabetizando com Jogos e Atividades Divertidas</span></h2>
            ...
            <div class="Mate-explicacao">
                <div class="livro-imagem">
                    <img src="/src/assets/img/material/livro-vermelho.png" alt=""/>
                </div>

                <div class="livro-texto">
                    <h2><span class="mat-red">Alfabetizando com Jogos e Atividades Divertidas</span></h2>
